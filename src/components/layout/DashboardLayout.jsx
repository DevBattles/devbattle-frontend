...
function DashboardLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-[#050816]">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 transform border-r border-slate-700 bg-[#111827] transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 ${
        ...
        <div className="flex h-full flex-col">
          ...
          <div className="flex items-center justify-between border-b border-slate-700 p-6">
            <Link to={getDashboardPath()} className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold text-white">DevBattles</span>
            </Link>
            <button
              onClick={() => setSidebarOpen(false)}
              className="lg:hidden"
          ...
          <div className="border-t border-slate-700 p-4">
            <div className="mb-4 flex items-center gap-3 rounded-xl bg-slate-800/50 p-3">
      ...
      <div className="flex flex-1 flex-col">
        {/* Top Bar */}
        <header className="flex items-center justify-between border-b border-slate-700 bg-[#111827]/50 backdrop-blur-sm px-6 py-4">
          ...
          <div className="flex items-center gap-4">
            <Link
              ...
              className="relative rounded-xl p-2 text-slate-400 transition hover:bg-slate-800/50 hover:text-white"
            >
            ...
            <Link
              ...
              className="flex items-center gap-3 rounded-xl bg-slate-800/50 px-4 py-2 transition hover:bg-slate-800"
            >
